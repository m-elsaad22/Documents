  ...
  <div class="rb">
    ...
    <div class="info-grid">
      <div class="info-cell">
        ...
        <div>
          ...
          <div class="ic-val">خادم الرميثي</div>
        </div>
      </div>
      <div class="info-cell">
        ...
        <div>
          ...
          <div class="ic-val">الجمعة، 19 يونيو 2026</div>
        </div>
      </div>
    ...
    <div style="display:flex;justify-content:flex-end;">
      <div class="stamp-box">
        ...
        <img src="<?= e($signature ?: $seal) ?>" alt="ختم وتوقيع" style="width:155px;height:155px;object-fit:contain;opacity:0.95;display:block;margin:4px auto 0;">
