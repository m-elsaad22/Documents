<?php
/**
 * KDMS Dynamic Document Template (EN)
...
<div class="page">
  ...
  <div class="ih">
    ...
    <div class="ih-top">
      ...
      <div class="doc-badge">
        <div class="db-type">Invoice No.</div>
  ...
  <div class="ib">
    ...
    <div class="info-grid">
      ...
      <div class="info-cell">
        ...
        <div>
          <div class="ic-label">Invoice Date</div>
      ...
      <div class="info-cell" style="grid-column:1/-1;">
        ...
        <div>
          <div class="ic-label">Customer Address</div>
    ...
    <table class="inv-table">
      <thead>
        <tr>
          ...
          <th>Description</th>
          <th style="width:76px;" class="center">Qty</th>
          <th style="width:82px;" class="center">Unit Price</th>
          <th style="width:86px;" class="center">Total</th>
        </tr>
      </thead>
      <tbody>
...
<?php endforeach; ?>
    ...
    <div class="totals-grand">
      <div>
        <div class="lbl">Total الكلي شامل جميع الأعمال</div>
        <div style="font-size:10px;color:rgba(255,255,255,0.55);margin-top:3px;"><i class="fas fa-check-circle" style="color:#68D391;margin-left:4px;"></i>Price includes VAT</div>
      </div>
    ...
    <div class="info-note">
      ...
      <div>
        <strong>Note:</strong> <?= nl2br(e($doc['notes'] ?? '')) ?></div>
    </div>

    <!-- Stamp only -->
    <div style="display:flex;justify-content:flex-end;">
      <div class="stamp-box">
        <div class="stamp-lbl">Company Seal & Signature</div>
        <div class="stamp-nm"><?= e($companyName) ?></div>
        <img src="<?= e($signature ?: $seal) ?>" alt="Company Seal & Signature" style="width:155px;height:155px;object-fit:contain;opacity:0.95;display:block;margin:4px auto 0;">
