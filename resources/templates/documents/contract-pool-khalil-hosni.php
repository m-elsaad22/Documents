...
<div class="page">
    ...
    <div class="hdr-inner">
      ...
      <div class="hdr-hero">
        ...
        <div class="contract-title">
          عقد صيانة وتنظيف <em>حوض السباحة</em><br>الخدمة الشهرية الشاملة
        </div>
        <div class="contract-sub">
          خدمة احترافية متكاملة بأعلى معايير الجودة — 4 زيارات شهرية بأحدث المعدات وأفضل المواد الكيميائية المعتمدة في الإمارات
        </div>
        <div class="client-strip">
          <div class="cs-pill"><i class="fas fa-user-tie"></i> <strong>خليل عباس سالم الحوسني</strong></div>
          <div class="cs-pill"><i class="fas fa-location-dot"></i> مشيرف — خريمة، أبوظبي</div>
  ...
  <div class="body">
    ...
    <!-- Preamble -->
    <div class="preamble">
      تم إبرام هذا العقد في يوم <strong>الخميس الموافق 25 يونيو 2026</strong> بين <strong>ركن التطور لأحواض السباحة ذ.م.م</strong> بوصفها الطرف المقدِّم للخدمة، وبين <strong>السيد / خليل عباس سالم الحوسني</strong> بوصفه صاحب العمل، وذلك على تقديم خدمة الصيانة الدورية الشاملة لحوض السباحة في الموقع المحدد أدناه، وفق الشروط والبنود المنصوص عليها في هذا العقد.
    </div>
    ...
    <div class="block fade-in">
      ...
      <div class="parties">
        ...
        <div class="party">
          ...
          <div class="party-body">
            <div class="pr"><span class="pr-l">الاسم:</span><span class="pr-v">خليل عباس سالم الحوسني</span></div>
            <div class="pr"><span class="pr-l">العنوان:</span><span class="pr-v">عزبة خليل الحوسني، مشيرف، خريمة، أبوظبي</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="block fade-in">
      ...
      <div class="pool-spec fade-in">
        ...
        <div class="pool-details">
          <h3>حوض سباحة خاص — مسبح عزبة الحوسني</h3>
          <div class="pool-tags">
            <div class="ptag"><i class="fas fa-ruler-combined"></i> الأبعاد: 3م × 7م</div>
            <div class="ptag"><i class="fas fa-expand"></i> المساحة: 21 م²</div>
            <div class="ptag"><i class="fas fa-calendar-check"></i> بداية الخدمة: 25 يونيو 2026</div>
            <div class="ptag"><i class="fas fa-repeat"></i> 4 زيارات / شهرياً</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="block fade-in">
      ...
      <ul class="steps">
        <li class="step">
          ...
          <div>
            <div class="step-title">التنظيف السطحي</div>
            <div class="step-desc">إزالة الشوائب وأوراق الشجر والحشرات العائمة بالشباك المخصصة</div>
          </div>
        </li>
        <li class="step">
          ...
          <div>
            ...
            <div class="step-desc">شفط الغبار والرمل المترسب في القاع بمكنسة المسابح الاحترافية</div>
          </div>
        </li>
        <li class="step">
          <div class="step-num">3</div>
          <div>
            <div class="step-title">تنظيف الجدران</div>
            <div class="step-desc">فرك جدران وأرضية المسبح بفرشاة خاصة لمنع تكون الطحالب والترسبات الجيرية</div>
          </div>
        </li>
        <li class="step">
        ...
        <li class="step">
          ...
          <div>
            <div class="step-title">إضافة المواد الكيميائية</div>
            <div class="step-desc">معالجة الماء بالمواد المعتمدة حسب نتيجة التحليل للحفاظ على صفاء الماء</div>
          </div>
        </li>
      </ul>
    </div>
    ...
    <div class="block fade-in">
      <div class="sec">
        ...
        <h2>جدول الزيارات والرسوم الشهرية</h2>
        <div class="sec-line"></div>
      </div>
      <div class="sched-block fade-in">
        <div class="sb-head">
          <div>
            <h3>الصيانة الشهرية الشاملة — 4 زيارات</h3>
            <div style="font-size:11px;color:rgba(255,255,255,.45);margin-top:3px;">شاملة جميع المواد الكيميائية والعمالة والمعدات</div>
          </div>
          <div class="sb-price">500 درهم / شهر</div>
        </div>
        <div class="sb-rows">
          <div class="sb-row">
            <div class="sbr-icon"><i class="fas fa-calendar-week"></i></div>
            <div><div class="sbr-label">عدد الزيارات</div><div class="sbr-val">4 زيارات شهرياً</div></div>
          </div>
          <div class="sb-row">
            <div class="sbr-icon"><i class="fas fa-clock"></i></div>
            <div><div class="sbr-label">تكرار الزيارات</div><div class="sbr-val">زيارة كل أسبوع</div></div>
          </div>
          <div class="sb-row">
          ...
          <div class="sb-row">
            ...
            <div><div class="sbr-label">موعد الدفع الشهري</div><div class="sbr-val">مطلع كل شهر</div></div>
          </div>
        </div>
      </div>
      ...
      <div class="first-month fade-in">
        ...
        <div>
          <div class="fm-title">الشهر الأول — مدفوع عند التوقيع</div>
          <div class="fm-text">يُسدَّد رسم الشهر الأول البالغ <strong>500 درهم</strong> في تاريخ توقيع هذا العقد (25 يونيو 2026) عبر التحويل البنكي، وتبدأ الزيارات الأسبوعية فور استلام الدفعة.</div>
        </div>
      </div>
    </div>
    ...
    <div class="block fade-in">
      ...
      <div class="ob-cols">
        <div>
          ...
          <div class="ob-item"><div class="ob-n">1</div>تنفيذ 4 زيارات شهرية منتظمة وفق الجدول المتفق عليه</div>
          ...
          <div class="ob-item"><div class="ob-n">4</div>الإبلاغ الفوري عن أي عطل في المعدات يحتاج تدخلاً إضافياً</div>
          <div class="ob-item"><div class="ob-n">5</div>إصدار تقرير موجز عن حالة المسبح عند الطلب</div>
        </div>
        <div>
          <div class="ob-head"><i class="fas fa-user-tie" style="color:var(--gold-m);"></i> الطرف الثاني يلتزم بـ:</div>
          <div class="ob-item"><div class="ob-n">1</div>سداد رسوم الشهر الأول (500 درهم) عند توقيع العقد اليوم</div>
          <div class="ob-item"><div class="ob-n">2</div>سداد الرسوم الشهرية في مطلع كل شهر عبر التحويل البنكي</div>
          <div class="ob-item"><div class="ob-n">3</div>توفير إمكانية الوصول للمسبح في مواعيد الزيارات المتفق عليها</div>
          <div class="ob-item"><div class="ob-n">4</div>الإبلاغ الفوري عن أي تغيير في حالة الماء أو المعدات</div>
          <div class="ob-item"><div class="ob-n">5</div>عدم إضافة مواد كيميائية من مصادر أخرى دون تنسيق</div>
        </div>
      </div>
    </div>
    ...
    <div class="block fade-in">
      ...
      <div class="clause"><div class="cl-n">1</div><div><strong>مدة العقد:</strong> يسري هذا العقد من تاريخ التوقيع ويُجدَّد تلقائياً شهرياً ما لم يُخطَر أي من الطرفين بالإنهاء قبل 15 يوماً من موعد التجديد.</div></div>
      <div class="clause"><div class="cl-n">2</div><div><strong>التأخر في الدفع:</strong> في حال تأخر سداد الرسوم الشهرية أكثر من 7 أيام، يحق للطرف الأول تعليق الخدمة حتى تسوية المستحقات كاملةً.</div></div>
    ...
    <div class="sig-section fade-in">
      ...
      <div class="sig-grid">
        ...
        <div class="sig-box">
          ...
          <div class="seal-wrap">
            <img class="seal-img"
                 src="<?= e($seal ?: asset('brand/sns-khtm-swimming.png')) ?>"
                 alt="ختم الشركة"
        ...
        <div class="sig-box">
          ...
          <div class="snm">خليل عباس سالم الحوسني</div>
  ...
  <footer>
    ...
    <div style="background:linear-gradient(135deg,var(--deep),var(--ocean),var(--marine));padding:16px 42px;display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:16px;border-top:3px solid var(--gold);">
      ...
      <div style="flex:1;min-width:220px;text-align:center;">
        ...
        <div style="display:inline-block;background:linear-gradient(90deg,var(--gold-lt),var(--gold-m));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;font-weight:700;font-size:11px;">RET-POOL-2026-0625 · 25 يونيو 2026</div>
