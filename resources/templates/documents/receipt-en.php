...
<div class="page">
  ...
  <div class="rb">
    ...
    <div class="amount-hero">
      <div>
        <div class="ah-label">Amount Received<span>الدفعة الأولى 75% من قيمة العقد</span></div>
        <div class="ah-badge">Received</div>
      </div>
      <div class="ah-amount">
    ...
    <div class="note-box">
      ...
      <div><strong>Important note:</strong> <?= nl2br(e($doc['notes'] ?? '')) ?></div>
    </div>
    ...
    <!-- Written Amount -->
    <div class="written">
      Amount in words: &nbsp;<em><?= e($amountWords) ?></em>
    </div>
