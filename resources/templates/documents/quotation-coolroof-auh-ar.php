...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="quote-meta">
      ...
      <div class="quote-meta-item"><i class="fas fa-calendar"></i> تاريخ الإصدار: يونيو 2025</div>
...
<?php endforeach; ?>
      ...
      <table class="price-table">
        ...
        <tbody>
          <tr>
            ...
            <td><strong style="color:var(--blue-dark);font-size:16px;">3,000 درهم</strong></td>
          </tr>
          <tr>
            <td>
            ...
            <td><strong style="color:var(--blue-dark);font-size:16px;">5,400 درهم</strong></td>
          </tr>
          <tr>
            <td>
            ...
            <td><strong style="color:var(--gold);font-size:16px;">7,800 درهم</strong></td>
          </tr>
          <tr>
            <td>
            ...
            <td><strong style="color:var(--blue-accent);font-size:16px;">9,600 درهم</strong></td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="cta-section fade-in">
      ...
      <div class="cta-buttons">
        <a href="https://wa.me/971501234567?text=السلام عليكم، أنا عبدالله السويدي، اطلعت على عرض السعر الخاص بعزل سطح فيلا 16 شارع السماح مدينة خليفة أبوظبي، وأريد اعتماد العرض والمضي قدماً. أرجو التواصل." class="btn btn-primary" target="_blank">
...
<footer class="footer">
  <p>
    <strong>ركن التطور للمقاولات والخدمات الفنية</strong> · أبوظبي، الإمارات العربية المتحدة<br>
