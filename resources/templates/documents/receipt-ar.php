  ...
  <div class="rb">
    ...
    <div class="info-grid">
      ...
      <div class="info-cell">
        ...
        <div>
          <div class="ic-label">تاريخ السداد</div>
      ...
      <div class="info-cell" style="grid-column:1/-1;">
        ...
        <div>
          <div class="ic-label">عنوان المشروع</div>
    ...
    <!-- Description -->
    <div class="desc-box">
      تم استلام المبلغ أعلاه من <strong>السيد / عادل عمار على سالم</strong> وذلك كـ <strong>دفعة أولى (75%)</strong> من القيمة الإجمالية للعقد رقم <strong>RET-CON-2026-0609</strong>، والمتعلق بـ:
    ...
    <div class="pay-method">
      ...
      <div>
        <div class="pm-label">طريقة السداد</div>
