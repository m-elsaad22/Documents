...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="quote-meta">
      <div class="quote-meta-item"><i class="fas fa-hashtag"></i> RET-CON-AJM-2026-0719</div>
...
<?php endforeach; ?>
        ...
        <div class="info-badges">
          <div class="info-badge"><i class="fas fa-ruler-combined"></i> المساحة Totalة: <strong>55 متر مربع</strong></div>
        ...
        <div class="price-table-wrap" style="margin-bottom:0;box-shadow:none;border-radius:20px 20px 0 0;">
          <table class="price-table">
            ...
            <tbody>
              ...
              <tr class="total-row">
                <td colspan="3">Total قبل الخصم</td>
      ...
      <div class="sig-grid">
        <div class="sig-box">
          ...
          <div class="sig-images">
            <img class="combined" src="<?= e($seal ?: asset('brand/khtm.webp')) ?>" alt="ختم وتوقيع ركن التطور">
          </div>
        </div>
        <div class="sig-box">
